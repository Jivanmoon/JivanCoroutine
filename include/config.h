#ifndef __JIVAN_CONFIG_H__
#define __JIVAN_CONFIG_H__
    ...
    public:
        ...
        std::string toString() override {
            try {
                ...
                JIVAN_LOG_ERROR(JIVAN_LOG_ROOT()) << "ConfigVar::toString exception "
        ...
        bool fromString(const std::string &val) override {
            try {
                ...
                JIVAN_LOG_ERROR(JIVAN_LOG_ROOT()) << "ConfigVar::fromString exception "
    ...
    public:
        ...
        static typename ConfigVar<T>::ptr Lookup(const std::string &name,
            ...
            if (it != GetDatas().end()) {
                ...
                if (tmp) {
                    JIVAN_LOG_INFO(JIVAN_LOG_ROOT()) << "Lookup name=" << name << " exists";
                    return tmp;
                } else {
                    JIVAN_LOG_ERROR(JIVAN_LOG_ROOT()) << "Lookup name=" << name << " exists but type not "
            ...
            if (name.find_first_not_of("abcdefghikjlmnopqrstuvwxyz._012345678") != std::string::npos) {
                JIVAN_LOG_ERROR(JIVAN_LOG_ROOT()) << "Lookup name invalid " << name;
